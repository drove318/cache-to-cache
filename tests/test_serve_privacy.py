...
class TestNoTextFilter:
    ...
    def test_keys_are_kept_as_is(self):
        ...
        message = {"role": "assistant", "id": "chatcm-1", "content": "the words of the wind"}
...
class TestTheWire:
    ...
    def test_the_served_wire_of_the_proxy(self):
        ...
        httpd = create_server(
            ServeConfig(host="127.0.0.1", port=0, api_key="k", privacy=True), hub=hub
        )
        ...
        try:
            ...
            body = json.dumps(
                {
                    "model": "receiver-mini",
                    "messages": [{"role": "user", "content": "the secret of the machines"}],
                    "max_tokens": 2,
                }
            ).encode("utf-8")
...
class TestTheSealAtThePipe:
    ...
    def test_a_sealed_front_answers_alone(self):
        ...
        out = pipeline.complete(
            ...
            prompt_text="what is two plus two",
            max_new_tokens=6,
            temperature=0.0,
            tools=None,
            stop=None,
